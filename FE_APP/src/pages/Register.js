...
const Register = () => {
    ...
    const [message, setMessage] = useState("Vui lòng đăng ký...")
        ...
        >
            ...
            <View style={styles.auth_main}>
                ...
                <TextInput  
                    ...
                    secureTextEntry={true}
                    onChangeText={(value) => handleChange("accuracy", value)}
                />
            </View>
            <View style={[styles.center, styles.auth_block]}>
                ...
                >
                    <Text style={styles.auth_btn_submit_content}>Đăng ký</Text>
                </TouchableOpacity>
                ...
                <View style={[styles.center_y, styles.auth_account_navigate]}>
                    ...
                    >
                        <Text style={styles.auth_account_btn}>Đăng nhập</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </ImageBackground>
